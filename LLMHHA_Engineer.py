...
def main():
    global DimSize, LB, UB, MaxFEs, MaxIter, Trials, Pop, Off
    ...
    for i in range(len(Probs)):
        ...
        for j in range(Trials):
            ...
            Trace = LLMHHA(Probs[i])
            All_Trial_Best.append(Trace)
        np.savetxt("./LLMHHA_Data/Engineer/" + Names[i] + ".csv", All_Trial_Best, delimiter=",")


if __name__ == "__main__":
    if os.path.exists('LLMHHA_Data/Engineer') == False:
        os.makedirs('LLMHHA_Data/Engineer')
    main()
